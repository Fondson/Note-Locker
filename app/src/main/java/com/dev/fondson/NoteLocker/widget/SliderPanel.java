...
package com.dev.fondson.NoteLocker.widget;
...
import com.dev.fondson.NoteLocker.MainActivity;
...
public class SliderPanel extends FrameLayout {
    ...
    private ViewDragHelper.Callback mBottomCallback = new ViewDragHelper.Callback() {
        ...
        public void onViewPositionChanged(View changedView, int left, int top, int dx, int dy) {
            super.onViewPositionChanged(changedView, left, top, dx, dy);
            float percent = 1f - ((float)Math.abs(top) / ((float)mScreenHeight/5));
    ...
    public void applyScrim(float percent){
        ...
        //MainActivity.getBackground().setAlpha(alpha);
